...
const initChart = () => {
  ...
  chart = createChart(chartContainer.value, {
    ...
    rightPriceScale: { borderColor: '#333', scaleMargins: { top: 0.1, bottom: 0.1 }, minimumWidth: 65 },
  ...
  <div class="relative w-full h-full overflow-hidden">
    ...
    >
      <div class="flex flex-col gap-0.5">
        <span v-if="hoverBalance !== null" class="text-[#f59e0b]">餘額 {{ formatValue(hoverBalance) }}</span>
